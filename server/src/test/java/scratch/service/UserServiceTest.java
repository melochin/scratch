...
/*	@Test
	...
	public void findUserTest() {
		...
		// 用户账号密码校验
		Authentication authentication = userService.authen("consequent", "hejianok");
		assertTrue("getByNameAndPwd fail", authentication.getPrincipal() != null);
	...
	public void activitTest() throws NoSuchMethodException, SecurityException, IllegalAccessException, IllegalArgumentException, InvocationTargetException, InterruptedException {
		...
		assertTrue(userService.confirmEmail(userId, activiCode) == 1);
	}
