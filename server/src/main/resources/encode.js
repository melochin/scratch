...
function decodeAction(string) {
    str = setStr(string, authkey);
    return utf8to16(str);
}

function setStr(str, key) {
    var key = key ? key : '';
    var ckey_length = 4;
    key = md5(key);
    ...
    var string = base64_decode(str.substr(ckey_length));
...
function microtime(get_as_float) {
    ...
    return get_as_float ? (unixtime_ms / 1000) : (unixtime_ms - (sec * 1000)) / 100000000 + ' ' + sec;
}
