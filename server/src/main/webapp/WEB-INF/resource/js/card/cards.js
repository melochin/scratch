...
var Card = React.createClass({
    ...
    render : function() {
        ...
        if(this.props.isLast) {
            button  = <button className="ui teal fluid button" onClick={() => {
                this.props.onRightClick();
                this.props.onComplete();
            }}>完成</button>
        } else {
            button  = <button className="ui fluid button" onClick={this.props.onRightClick}>下一个</button>
        }
        return(
            <div className="ui centered card" style={{width:"100%"}}>
                ...
                <div className="extra content">
                    <div className="ui grid">
                        ...
                        <div className="ui sixteen wide tablet six wide computer column ">
                            {button}
                        </div>
                        <div className="ui five wide computer only column"></div>
                    </div>
